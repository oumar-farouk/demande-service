            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->roles == 'ROLE_ADMIN')
                        ...
                        <x-nav-link :href="route('citoyens.index')" :active="request()->routeIs('citoyens.index')">
                            {{ __('Citoyens') }}
                        </x-nav-link>
                        <x-nav-link :href="route('pieces.index')" :active="request()->routeIs('pieces.index')">
                            {{ __('Pièces') }}
                        </x-nav-link>
                        <x-nav-link :href="route('demandepieces.index')" :active="request()->routeIs('demandepieces.index')">
                            {{ __('Pièces-jointes') }}
                        </x-nav-link>
                    @endif
                </div>
